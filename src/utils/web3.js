...
module.exports = {
  ICU: {
    address: "0xC5E4D6d780190Dd7F6faB9dc833D086AE35d8640",
    ABI: [
      {
        inputs: [
      ...
      },
      {
        constant: true,
        inputs: [],
        name: "Autopool_Level_Incometoken",
        outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
        payable: false,
        stateMutability: "view",
        type: "function",
